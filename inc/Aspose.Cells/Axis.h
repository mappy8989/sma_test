...
public:
    ...
    /// @deprecated Use Axis.CustomDisplayUnit property, instead.
    [[deprecated]] ASPOSE_CELLS_API int32_t GetCustomUnit();
    /// <summary>
    /// Specifies a custom value for the display unit.
    /// </summary>
    /// <remarks>NOTE: This property is now obsolete. Instead,
    ...
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use Axis.CustomDisplayUnit property, instead.
    [[deprecated]] ASPOSE_CELLS_API void SetCustomUnit(int32_t value);
    /// <summary>
    /// Specifies a custom value for the display unit.
    /// </summary>
    ASPOSE_CELLS_API double GetCustomDisplayUnit();
    /// <summary>
    /// Specifies a custom value for the display unit.
    /// </summary>
    ASPOSE_CELLS_API void SetCustomDisplayUnit(double value);
    /// <summary>
