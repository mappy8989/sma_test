...
public:
    ...
    /// </summary>
    /// <param name="sheetIndexes">zero based sheet indexes.</param>
    /// <remarks>
    /// If a sheet is encountered that is not in the workbook, an exception will be thrown during rendering.
    /// </remarks>
    ASPOSE_CELLS_API explicit SheetSet(const Vector<int32_t>& sheetIndexes);
    /// <summary>
    ...
    /// If a sheet is encountered that is not in the workbook, an exception will be thrown during rendering.
    /// </remarks>
    ASPOSE_CELLS_API explicit SheetSet(const Vector<U16String>& sheetNames);
    /// <summary>
