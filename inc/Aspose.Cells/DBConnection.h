...
public:
    ...
    [[deprecated]] ASPOSE_CELLS_API U16String GetConnectionInfo();
    /// <summary>
    /// The connection information string is used to make contact with an OLE DB or ODBC data source.
    /// </summary>
    /// <remarks>
    ...
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use ExternalConnection.ConnectionString property instead.
    [[deprecated]] ASPOSE_CELLS_API void SetConnectionInfo(const U16String& value);
    /// <summary>
    /// The connection information string is used to make contact with an OLE DB or ODBC data source.
    /// </summary>
    /// <remarks>
    ...
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use ExternalConnection.ConnectionString property instead.
    [[deprecated]] ASPOSE_CELLS_API void SetConnectionInfo(const char16_t* value);
    /// <summary>
    ...
    [[deprecated]] ASPOSE_CELLS_API U16String GetSeverCommand();
    /// <summary>
    /// Specifies a second command text string that is persisted when PivotTable server-based
    /// page fields are in use.
    /// For ODBC connections, serverCommand is usually a broader query than command (no
    ...
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use ExternalConnection.SecondCommand property instead.
    [[deprecated]] ASPOSE_CELLS_API void SetSeverCommand(const U16String& value);
    /// <summary>
    /// Specifies a second command text string that is persisted when PivotTable server-based
    /// page fields are in use.
    /// For ODBC connections, serverCommand is usually a broader query than command (no
    ...
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use ExternalConnection.SecondCommand property instead.
    [[deprecated]] ASPOSE_CELLS_API void SetSeverCommand(const char16_t* value);
    /// <summary>
    /// Specifies a second command text string that is persisted when PivotTable server-based
    /// page fields are in use.
    /// For ODBC connections, serverCommand is usually a broader query than command (no
