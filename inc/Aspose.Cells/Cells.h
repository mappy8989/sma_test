...
public:
    ...
    /// <returns>Total column count of the split values.</returns>
    ASPOSE_CELLS_API int32_t TextToColumns(int32_t row, int32_t column, int32_t totalRows, const TxtLoadOptions& options);
    /// <summary>
    ...
    /// <param name="columnIndex">Index of the first column to be deleted.</param>
    /// <param name="totalColumns">Count of columns to be deleted.</param>
    /// <param name="options">Options for the deleting operation</param>
    ASPOSE_CELLS_API void DeleteColumns(int32_t columnIndex, int32_t totalColumns, const DeleteOptions& options);
    /// <summary>
    ...
    /// <param name="options">Options for the deleting operation</param>
    /// <returns></returns>
    ASPOSE_CELLS_API bool DeleteRows(int32_t rowIndex, int32_t totalRows, const DeleteOptions& options);
    /// <summary>
    ...
    /// <param name="columnIndex">Column index.</param>
    /// <param name="totalColumns">The number of columns.</param>
    /// <param name="options">The options for inserting operation.</param>
    ASPOSE_CELLS_API void InsertColumns(int32_t columnIndex, int32_t totalColumns, const InsertOptions& options);
    /// <summary>
    ...
    /// <param name="rowIndex">Row index.</param>
    /// <param name="totalRows">Number of rows to be inserted.</param>
    /// <param name="options">Options for inserting operation.</param>
    ...
    ASPOSE_CELLS_API Vector<Vector<Aspose::Cells::Object>> ExportArray(int32_t firstRow, int32_t firstColumn, int32_t totalRows, int32_t totalColumns);
    /// <summary>
