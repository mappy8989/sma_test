...
public:
    ...
    /// </summary>
    /// <param name="upperLeftRow"> Upper left row index.</param>
    /// <param name="top">Represents the vertical  offset of Polygon from its left row, in unit of pixel. </param>
    /// <param name="upperLeftColumn">Upper left column index.</param>
    /// <param name="left">Represents the horizontal offset of Polygon from its left column, in unit of pixel. </param>
    /// <param name="height">Represents the height of Polygon, in unit of pixel. </param>
    /// <param name="width">Represents the width of Polygon, in unit of pixel. </param>
    /// <param name="paths">Represents a user-defined path</param>
    /// <returns>A freeform shape.</returns>
    ASPOSE_CELLS_API Shape AddFreeform(int32_t upperLeftRow, int32_t top, int32_t upperLeftColumn, int32_t left, int32_t height, int32_t width, const Vector<ShapePath>& paths);
    /// <summary>
    /// Adds a Signature Line to the worksheet.
    /// </summary>
    /// <param name="upperLeftRow">Upper left row index.</param>
    /// <param name="upperLeftColumn">Upper left column index.</param>
    /// <param name="signatureLine">Represents a signature line object.</param>
    /// <returns></returns>
    ASPOSE_CELLS_API Aspose::Cells::Drawing::Picture AddSignatureLine(int32_t upperLeftRow, int32_t upperLeftColumn, const SignatureLine& signatureLine);
