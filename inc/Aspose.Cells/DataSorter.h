...
public:
    ...
    /// </summary>
    /// <param name="key">The sorted column index(absolute position, column A is 0, B is 1, ...)</param>
    /// <param name="type">The sorted color value type.</param>
    /// <param name="order">The sort order.</param>
    /// <param name="color">The custom sort color.</param>
    ASPOSE_CELLS_API void AddColorKey(int32_t key, SortOnType type, SortOrder order, const Aspose::Cells::Color& color);
    /// <summary>
    /// Adds sorted column index and sort order with custom sort list.
    /// </summary>
    /// <param name="key">The sorted column index(absolute position, column A is 0, B is 1, ...)</param>
