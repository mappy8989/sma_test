...
#ifndef ASPOSE_CELLS_DRAWING_MSOLINEFORMAT_H
#define ASPOSE_CELLS_DRAWING_MSOLINEFORMAT_H
...
public:
    ...
    /// </summary>
    MsoLineFormat_Impl* _impl;
    
public:
    /// <summary>
    /// Constructs from an implementation object.
    /// </summary>
    ASPOSE_CELLS_API MsoLineFormat(MsoLineFormat_Impl* impl);
    /// <summary>
    /// Copy constructor.
    /// </summary>
    ASPOSE_CELLS_API MsoLineFormat(const MsoLineFormat& src);
    /// <summary>
    /// Destructor.
    /// </summary>
    ASPOSE_CELLS_API ~MsoLineFormat();
    /// <summary>
    /// operator=
    /// </summary>
    ASPOSE_CELLS_API MsoLineFormat& operator=(const MsoLineFormat& src);
    /// <summary>
    /// operator bool()
    /// </summary>
