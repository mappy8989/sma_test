...
public:
    ...
    /// <param name="formula">Formula to be calculated.</param>
    /// <param name="opts">Options for calculating formula</param>
    ASPOSE_CELLS_API Vector<Vector<Aspose::Cells::Object>> CalculateArrayFormula(const U16String& formula, const CalculationOptions& opts);
    /// <summary>
    /// Calculates a formula as array formula.
    /// </summary>
    /// <param name="formula">Formula to be calculated.</param>
    /// <param name="opts">Options for calculating formula</param>
    ASPOSE_CELLS_API Vector<Vector<Aspose::Cells::Object>> CalculateArrayFormula(const char16_t* formula, const CalculationOptions& opts);
    /// <summary>
    /// Calculates a formula as array formula.
    /// </summary>
    /// <param name="formula">Formula to be calculated.</param>
    ...
    /// </remarks>
    ASPOSE_CELLS_API Vector<Vector<Aspose::Cells::Object>> CalculateArrayFormula(const U16String& formula, const CalculationOptions& opts, int32_t maxRowCount, int32_t maxColumnCount);
    /// <summary>
    /// Calculates a formula as array formula.
    /// </summary>
    /// <param name="formula">Formula to be calculated.</param>
    ...
    /// but user does not need so large an array according to business requirement or for performance consideration.
    /// </remarks>
    ASPOSE_CELLS_API Vector<Vector<Aspose::Cells::Object>> CalculateArrayFormula(const char16_t* formula, const CalculationOptions& opts, int32_t maxRowCount, int32_t maxColumnCount);
    /// <summary>
    /// Calculates a formula as array formula.
    /// </summary>
    /// <param name="formula">Formula to be calculated.</param>
    ...
    /// but user does not need so large an array according to business requirement or for performance consideration.
    /// </remarks>
    ASPOSE_CELLS_API Vector<Vector<Aspose::Cells::Object>> CalculateArrayFormula(const U16String& formula, const FormulaParseOptions& pOpts, const CalculationOptions& cOpts, int32_t baseCellRow, int32_t baseCellColumn, int32_t maxRowCount, int32_t maxColumnCount, const CalculationData& calculationData);
    /// <summary>
    /// Calculates a formula as array formula.
    /// </summary>
    /// <param name="formula">Formula to be calculated.</param>
    ...
    /// but user does not need so large an array according to business requirement or for performance consideration.
    /// </remarks>
    ASPOSE_CELLS_API Vector<Vector<Aspose::Cells::Object>> CalculateArrayFormula(const char16_t* formula, const FormulaParseOptions& pOpts, const CalculationOptions& cOpts, int32_t baseCellRow, int32_t baseCellColumn, int32_t maxRowCount, int32_t maxColumnCount, const CalculationData& calculationData);
    /// <summary>
    ...
    /// </param>
    ASPOSE_CELLS_API bool RefreshPivotTables(const PivotTableRefreshOption& option);
