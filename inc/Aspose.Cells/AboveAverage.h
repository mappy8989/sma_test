...
class AboveAverage
{
  ...
  public:
    ...
    /// operator bool()
    /// </summary>
    /// <returns>Returns true if the implementation object is not nullptr.
    /// Otherwise, returns false</returns>
    ASPOSE_CELLS_API explicit operator bool() const
    {
    ...
    /// </summary>
    /// <returns>Returns true if the implementation object is nullptr.
    /// Otherwise, returns false</returns>
  ...
  public:
    /// <summary>
    /// Get or set the flag indicating whether the rule is an "above average"
    /// rule. 'true' indicates 'above average'. Default value is true.
    /// </summary>
    ...
    /// <summary>
    /// Get or set the flag indicating whether the 'aboveAverage' and
    /// 'belowAverage' criteria is inclusive of the average itself, or exclusive
    /// of that value. 'true' indicates to include the average value in the
    /// criteria. Default value is false.
    /// </summary>
    ...
    /// <summary>
    /// Get or set the number of standard deviations to include above or below
    /// the average in the conditional formatting rule. The input value must
    /// between 0 and 3 (include 0 and 3). Setting this value to 0 means stdDev
