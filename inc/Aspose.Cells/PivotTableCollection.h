...
public:
    ...
    /// <param name="useSameSource">Indicates whether using same data source when another existing pivot table has used this data source.
    /// If the property is true, it will save memory.</param>
    /// <param name="isXlsClassic">
    /// Indicates whether add classic pivot table of Excel 97-2003.
    /// </param>
    /// <returns>The new added cache index.</returns>
    ASPOSE_CELLS_API int32_t Add(const U16String& sourceData, int32_t row, int32_t column, const U16String& tableName, bool useSameSource, bool isXlsClassic);
    /// <summary>
    /// Adds a new PivotTable.
    /// </summary>
    /// <param name="sourceData">The data cell range for the new PivotTable.Example : Sheet1!A1:C8</param>
    ...
    /// </param>
    /// <returns>The new added cache index.</returns>
    ASPOSE_CELLS_API int32_t Add(const char16_t* sourceData, int32_t row, int32_t column, const char16_t* tableName, bool useSameSource, bool isXlsClassic);
    /// <summary>
    /// Adds a new PivotTable.
    /// </summary>
    /// <param name="sourceData">The data cell range for the new PivotTable.Example : Sheet1!A1:C8</param>
    /// <param name="cell">The cell in the upper-left corner of the PivotTable report's destination range.</param>
    /// <param name="tableName">The name of the new PivotTable report.</param>
    /// <param name="useSameSource">Indicates whether using same data source when another existing pivot table has used this data source.
    /// If the property is true, it will save memory.</param>
    /// <param name="isXlsClassic">
    ...
    /// </param>
    /// <returns>The new added cache index.</returns>
    ASPOSE_CELLS_API int32_t Add(const U16String& sourceData, const U16String& cell, const U16String& tableName, bool useSameSource, bool isXlsClassic);
    /// <summary>
    /// Adds a new PivotTable.
    /// </summary>
    /// <param name="sourceData">The data cell range for the new PivotTable.Example : Sheet1!A1:C8</param>
    ...
    /// </param>
    /// <returns>The new added cache index.</returns>
    ASPOSE_CELLS_API int32_t Add(const char16_t* sourceData, const char16_t* cell, const char16_t* tableName, bool useSameSource, bool isXlsClassic);
    /// <summary>
