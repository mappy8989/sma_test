...
public:
    ...
    ASPOSE_CELLS_API void SelectField(PivotFieldType axisType, const U16String& fieldName);
    /// <summary>
    /// Select a field in the region as an area.
    /// </summary>
    /// <param name="axisType">The region type.</param>
    /// <param name="fieldName">The name of pivot field.</param>
    ASPOSE_CELLS_API void SelectField(PivotFieldType axisType, const char16_t* fieldName);
    /// <summary>
    /// Select a field in the region as an area.
    /// </summary>
    /// <param name="axisType">The region type.</param>
    /// <param name="field">The pivot field.</param>
    ASPOSE_CELLS_API void SelectField(PivotFieldType axisType, const PivotField& field);
    /// <summary>
