...
public:
    ...
    /// </summary>
    ASPOSE_CELLS_API bool GetPropertiesFollowChartPoint();
    /// <summary>
    /// Indicates whether datapoint properties and datalabels in all charts in this workbook follow their reference.
    /// </summary>
    ASPOSE_CELLS_API void SetPropertiesFollowChartPoint(bool value);
    /// <summary>
    /// Indicates whether discarding editting image data.
    /// </summary>
    ASPOSE_CELLS_API bool GetDiscardImageEditData();
    /// <summary>
    /// Indicates whether discarding editting image data.
    /// </summary>
    ASPOSE_CELLS_API void SetDiscardImageEditData(bool value);
    /// <summary>
    /// Gets and sets default resolution of image.
    /// </summary>
    ASPOSE_CELLS_API int32_t GetDefaultImageResolution();
    /// <summary>
    /// Gets and sets default resolution of image.
    /// </summary>
    ASPOSE_CELLS_API void SetDefaultImageResolution(int32_t value);
