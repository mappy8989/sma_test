...
public:
    ...
    /// It should be one of following types: <see cref="SaveFormat.Html"/>  or <see cref="SaveFormat.MHtml"/>,
...
public:
    ...
    /// The default value is false.
    /// </summary>
    ASPOSE_CELLS_API bool GetDisableCss();
    /// <summary>
    /// Indicates whether only inline styles are applied, without relying on CSS.
    /// The default value is false.
    /// </summary>
    ASPOSE_CELLS_API void SetDisableCss(bool value);
    /// <summary>
    ...
    /// The default value is false.
    /// </summary>
    ASPOSE_CELLS_API bool GetEnableCssCustomProperties();
    /// <summary>
    /// Optimize the output of html by using CSS custom properties. For example, for the scenario that there are multiple occurences for one base64 image, with custom property the image data only needs to be saved once so the performance of the resultant html can be improved.
    /// The default value is false.
    /// </summary>
    ASPOSE_CELLS_API void SetEnableCssCustomProperties(bool value);
    /// <summary>
    /// Specifies version of HTML standard that should be used when saving the HTML format.
    /// Default value is HtmlVersion.Default.
    /// </summary>
    ASPOSE_CELLS_API HtmlVersion GetHtmlVersion();
    /// <summary>
    /// Specifies version of HTML standard that should be used when saving the HTML format.
    /// Default value is HtmlVersion.Default.
    /// </summary>
    ASPOSE_CELLS_API void SetHtmlVersion(HtmlVersion value);
