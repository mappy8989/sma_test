...
using namespace Aspose::Cells::DataModels;
...
public:
    ...
    /// Creates a new style.
    /// </summary>
    /// <param name="cloneDefaultStyle">Incidates whether clones the default style</param>
    /// <returns>Returns a style object.</returns>
    ASPOSE_CELLS_API Style CreateStyle(bool cloneDefaultStyle);
    /// <summary>
    ...
    /// </summary>
    ASPOSE_CELLS_API DataModel GetDataModel();
    /// <summary>
