...
public:
    ...
    ASPOSE_CELLS_API void SetFormula(const U16String& formula, const FormulaParseOptions& options);
    /// <summary>
    /// Set the formula and the value(calculated result) of the formula.
    /// </summary>
    /// <param name="formula">The formula.</param>
    /// <param name="options">Options for parsing the formula.</param>
    ASPOSE_CELLS_API void SetFormula(const char16_t* formula, const FormulaParseOptions& options);
    /// <summary>
    ...
    /// <param name="columnNumber">Number of columns to populate result of the array formula.</param>
    /// <param name="options">Options for parsing the formula.</param>
    /// <param name="values">values for those cells with given array formula</param>
    ASPOSE_CELLS_API void SetArrayFormula(const U16String& arrayFormula, int32_t rowNumber, int32_t columnNumber, const FormulaParseOptions& options, const Vector<Vector<Aspose::Cells::Object>>& values);
    /// <summary>
    /// Sets an array formula to a range of cells.
    /// </summary>
    /// <param name="arrayFormula">Array formula.</param>
    ...
    /// <param name="options">Options for parsing the formula.</param>
    /// <param name="values">values for those cells with given array formula</param>
    ASPOSE_CELLS_API void SetArrayFormula(const char16_t* arrayFormula, int32_t rowNumber, int32_t columnNumber, const FormulaParseOptions& options, const Vector<Vector<Aspose::Cells::Object>>& values);
    /// <summary>
    ...
    /// <param name="columnNumber">Number of columns to populate the formula.</param>
    /// <param name="options">Options for parsing the formula.</param>
    /// <param name="values">values for those cells with given shared formula</param>
    ASPOSE_CELLS_API void SetSharedFormula(const U16String& sharedFormula, int32_t rowNumber, int32_t columnNumber, const FormulaParseOptions& options, const Vector<Vector<Aspose::Cells::Object>>& values);
    /// <summary>
    /// Sets shared formulas to a range of cells.
    /// </summary>
    /// <param name="sharedFormula">Shared formula.</param>
    ...
    /// <param name="options">Options for parsing the formula.</param>
    /// <param name="values">values for those cells with given shared formula</param>
    ASPOSE_CELLS_API void SetSharedFormula(const char16_t* sharedFormula, int32_t rowNumber, int32_t columnNumber, const FormulaParseOptions& options, const Vector<Vector<Aspose::Cells::Object>>& values);
    /// <summary>
    ...
    /// <param name="options">options to parse formula.
    /// "Parse" option will be ignored and the formula will always be parsed immediately</param>
    /// <param name="values">values(calculated results) for those cells with given dynamic array formula</param>
    /// <param name="calculateRange">
    ...
    /// If there are non-empty cells in the range, the formula will be set for current cell only and marked as "#SPILL!".
    /// But for such kind of situation we still return the whole range that this formula should spill into.</remarks>
    ASPOSE_CELLS_API CellArea SetDynamicArrayFormula(const U16String& arrayFormula, const FormulaParseOptions& options, const Vector<Vector<Aspose::Cells::Object>>& values, bool calculateRange, bool calculateValue);
    /// <summary>
    /// Sets dynamic array formula and make the formula spill into neighboring cells if possible.
    /// </summary>
    /// <param name="arrayFormula">the formula expression</param>
    ...
    /// If there are non-empty cells in the range, the formula will be set for current cell only and marked as "#SPILL!".
    /// But for such kind of situation we still return the whole range that this formula should spill into.</remarks>
    ASPOSE_CELLS_API CellArea SetDynamicArrayFormula(const char16_t* arrayFormula, const FormulaParseOptions& options, const Vector<Vector<Aspose::Cells::Object>>& values, bool calculateRange, bool calculateValue);
    /// <summary>
    /// Sets dynamic array formula and make the formula spill into neighboring cells if possible.
    /// </summary>
    /// <param name="arrayFormula">the formula expression</param>
    ...
    /// or corresponding item in "values" for one cell is null.
    /// </param>
    /// <param name="copts">The options for calculating formula.
    /// Commonly, for performance consideration, the <see cref="CalculationOptions.Recursive"/> property should be false.</param>
    /// <returns>the range that the formula should spill into.</returns>
    /// <remarks>the returned range may be not same with the actual one that this dynamic array formula spills into.
    /// If there are non-empty cells in the range, the formula will be set for current cell only and marked as "#SPILL!".
    /// But for such kind of situation we still return the whole range that this formula should spill into.</remarks>
    ASPOSE_CELLS_API CellArea SetDynamicArrayFormula(const U16String& arrayFormula, const FormulaParseOptions& options, const Vector<Vector<Aspose::Cells::Object>>& values, bool calculateRange, bool calculateValue, const CalculationOptions& copts);
    /// <summary>
    /// Sets dynamic array formula and make the formula spill into neighboring cells if possible.
    /// </summary>
    /// <param name="arrayFormula">the formula expression</param>
    ...
    /// If there are non-empty cells in the range, the formula will be set for current cell only and marked as "#SPILL!".
    /// But for such kind of situation we still return the whole range that this formula should spill into.</remarks>
    ASPOSE_CELLS_API CellArea SetDynamicArrayFormula(const char16_t* arrayFormula, const FormulaParseOptions& options, const Vector<Vector<Aspose::Cells::Object>>& values, bool calculateRange, bool calculateValue, const CalculationOptions& copts);
    /// <summary>
    ...
    ASPOSE_CELLS_API void SetTableFormula(int32_t rowNumber, int32_t columnNumber, const U16String& rowInputCell, const U16String& columnInputCell, const Vector<Vector<Aspose::Cells::Object>>& values);
    /// <summary>
    /// Create two-variable data table for given range starting from this cell.
    /// </summary>
    /// <param name="rowNumber">Number of rows to populate the formula.</param>
    ...
    /// <param name="columnInputCell">the column input cell</param>
    /// <param name="values">values for cells in table formula range</param>
    ASPOSE_CELLS_API void SetTableFormula(int32_t rowNumber, int32_t columnNumber, const char16_t* rowInputCell, const char16_t* columnInputCell, const Vector<Vector<Aspose::Cells::Object>>& values);
    /// <summary>
    ...
    /// <param name="values">values for cells in table formula range</param>
    ASPOSE_CELLS_API void SetTableFormula(int32_t rowNumber, int32_t columnNumber, const U16String& inputCell, bool isRowInput, const Vector<Vector<Aspose::Cells::Object>>& values);
    /// <summary>
    /// Create one-variable data table for given range starting from this cell.
    /// </summary>
    /// <param name="rowNumber">Number of rows to populate the formula.</param>
    ...
    /// <param name="isRowInput">Indicates whether the input cell is a row input cell(true) or a column input cell(false).</param>
    /// <param name="values">values for cells in table formula range</param>
    ASPOSE_CELLS_API void SetTableFormula(int32_t rowNumber, int32_t columnNumber, const char16_t* inputCell, bool isRowInput, const Vector<Vector<Aspose::Cells::Object>>& values);
    /// <summary>
    /// Create two-variable data table for given range starting from this cell.
    /// </summary>
    /// <param name="rowNumber">Number of rows to populate the formula.</param>
    ...
    /// <param name="values">values for cells in table formula range</param>
    ASPOSE_CELLS_API void SetTableFormula(int32_t rowNumber, int32_t columnNumber, int32_t rowIndexOfRowInputCell, int32_t columnIndexOfRowInputCell, int32_t rowIndexOfColumnInputCell, int32_t columnIndexOfColumnInputCell, const Vector<Vector<Aspose::Cells::Object>>& values);
    /// <summary>
    /// Create one-variable data table for given range starting from this cell.
    /// </summary>
    /// <param name="rowNumber">Number of rows to populate the formula.</param>
    ...
    /// <param name="isRowInput">Indicates whether the input cell is a row input cell(true) or a column input cell(false).</param>
    /// <param name="values">values for cells in table formula range</param>
    ASPOSE_CELLS_API void SetTableFormula(int32_t rowNumber, int32_t columnNumber, int32_t rowIndexOfInputCell, int32_t columnIndexOfInputCell, bool isRowInput, const Vector<Vector<Aspose::Cells::Object>>& values);
    /// <summary>
    ...
    /// </summary>
    ASPOSE_CELLS_API CellRichValue GetRichValue();
    /// <summary>
