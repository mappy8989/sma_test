...
enum class ErrorCheckType {
    ...
    TextNumber [[deprecated]] = 0x00000004,
    /// <summary>
    ...
    TextDate [[deprecated]] = 0x00000020,
    /// <summary>
    ...
    UnproctedFormula [[deprecated]] = 0x00000040,
    /// <summary>
    ...
    Validation [[deprecated]] = 0x00000080,
    /// <summary>
