...
public:
    ...
    /// </summary>
    ASPOSE_CELLS_API U16String GetSvgCssPrefix();
    /// <summary>
    /// Gets and sets the prefix of the css name in svg,the default value is empty string.
    /// </summary>
    ASPOSE_CELLS_API void SetSvgCssPrefix(const U16String& value);
    /// <summary>
    /// Gets and sets the prefix of the css name in svg,the default value is empty string.
    /// </summary>
    ASPOSE_CELLS_API void SetSvgCssPrefix(const char16_t* value);
    /// <summary>
